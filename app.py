...
st.markdown("""
<div style='text-align: center; padding: 2rem 0; background: linear-gradient(90deg, #667eea, #764ba2); border-radius: 1rem; margin-bottom: 2rem; box-shadow: 0 8px 16px rgba(0,0,0,0.2);'>
...
with st.sidebar:
    ...
    <div style='background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 1rem; border-radius: 0.5rem; margin-bottom: 1rem;'>
        <h3 style='color: white; text-align: center; margin: 0;'>🎯 Input Parameter</h3>
    </div>
    """, unsafe_allow_html=True)
